...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -1.3999  # This is APPROXIMATELY the correct answer.
    answer = problem1a(4, 6)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -1.2442  # This is APPROXIMATELY the correct answer.
    answer = problem1a(7, 10)
    print()
